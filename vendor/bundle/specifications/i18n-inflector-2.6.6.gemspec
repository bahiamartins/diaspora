...
Gem::Specification.new do |s|
  ...
  s.date = "2012-03-14"
  s.description = "Enhances simple I18n backend in a way that it inflects translation data using pattern interpolation."
  s.email = ["pw@gnu.org"]
  s.extra_rdoc_files = ["Manifest.txt", "README.rdoc"]
  s.files = ["Manifest.txt", "README.rdoc"]
  ...
  s.summary = "Inflection module for I18n"
