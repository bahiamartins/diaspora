...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CHANGELOG.rdoc", "README.rdoc", "LICENSE"]
  s.files = ["CHANGELOG.rdoc", "README.rdoc", "LICENSE"]
  s.homepage = "http://github.com/judofyr/ruby-oembed"
  s.licenses = ["MIT"]
  s.rdoc_options = ["--main", "README.rdoc", "--title", "ruby-oembed-0.8.8", "--inline-source", "--exclude", "tasks", "CHANGELOG.rdoc"]
  s.require_paths = ["lib"]
